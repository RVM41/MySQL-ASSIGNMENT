...
## 4. Retrieve customer_name and Ordered_Item from the sales_orders table.
select  Costomer_Name,Ordered_item from  sales_orders;

 ## 5. Use the update command to change the name of the product for any row.
Update sales_orders set Ordered_item ="Tv Remote" where Order_ID =1005;
select * from sales_orders;

update sales_orders set Costomer_Name ="Ramesh" where Order_ID =1005;
